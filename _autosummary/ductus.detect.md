...
`tells`
: Catalogue phrase matches (see [`ductus.tells`](ductus.tells.md#module-ductus.tells)). Finds vocabulary.
...
`binoculars`, in [`ductus.curvature`](ductus.curvature.md#module-ductus.curvature). They are registered here so they can be
...
### ductus.detect.DETECTORS *: [dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), [Callable](https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable)[[[str](https://docs.python.org/3/builtins/stdtypes.html#str), [Span](ductus.base.md#ductus.base.Span)], [Iterator](https://docs.python.org/3/library/collections.abc.html#collections.abc.Iterator)[[Signal](ductus.base.md#ductus.base.Signal)]]]* *= {'binoculars': <function binoculars>, 'fast-detect-gpt': <function fast_detect_gpt>, 'forensic': <function forensic>, 'rhetoric': <function rhetoric>, 'rhythm': <function rhythm>, 'tells': <function tells>}*
...
[`ductus.curvature`](ductus.curvature.md#module-ductus.curvature) imports nothing heavier than [`ductus.base`](ductus.base.md#module-ductus.base) until one
