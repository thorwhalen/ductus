...
Like [`ductus.mcp`](ductus.mcp.html.md#module-ductus.mcp), there is **no second verb list here**. [`ROUTED_FUNCS`](#ductus.http.ROUTED_FUNCS)
...
definition – the same rule, and the same reason, as [`ductus.mcp`](ductus.mcp.html.md#module-ductus.mcp).
