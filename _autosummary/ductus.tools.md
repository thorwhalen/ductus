...
remote MCP caller did not necessarily, so [`ductus.mcp`](ductus.mcp.md#module-ductus.mcp) leaves them out.
...
– so [`ductus.http`](ductus.http.md#module-ductus.http) refuses them, driven by this declaration rather than by
