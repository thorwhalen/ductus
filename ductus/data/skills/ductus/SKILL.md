...
2. **This tool falsely accuses about one human writer in sixteen.** Measured, not estimated: across 350 human-written texts, the shipped defaults call 6% of them `leans-machine` (it was 20.6% before the rules and the document roll-up were corrected). Every one of those is wrong. A flagged **sentence** is still much better evidence than a flagged **document**; the per-sentence rate is 0.4–2%. The remaining errors land hardest on intermediate and advanced non-native writers, at about 10%.
